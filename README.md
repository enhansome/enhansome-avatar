...
|          3DGS          |             [3D Gaussian Splatting for Real-Time Radiance Field Rendering](https://arxiv.org/abs/2308.04079), Inria, SIGGRAPH 2023            | [A Comprehensive Overview of Gaussian Splatting](https://towardsdatascience.com/a-comprehensive-overview-of-gaussian-splatting-e7d570081362) | [Code](https://github.com/graphdeco-inria/gaussian-splatting) ⭐ 23,656 \| 🐛 713 \| 🌐 Python \| 📅 2025-10-17 |       real-time 3d rendering      |
...
|                    |                                                                                                                                                                                             |                      Tencent TMElyralab                      |                                [MuseTalk: Real-Time High Quality Lip Synchorization with Latent Space Inpainting](https://github.com/TMElyralab/MuseTalk) ⭐ 6,474 \| 🐛 171 \| 🌐 Python \| 📅 2025-09-26 ![Github stars](https://img.shields.io/github/stars/TMElyralab/MuseTalk.svg) ![Github forks](https://img.shields.io/github/forks/TMElyralab/MuseTalk.svg)                                |               |                                                                                                                                                                           |
...
3. CodeFormer: Robust Blind Face Restoration <https://github.com/sczhou/CodeFormer> ⭐ 18,118 | 🐛 282 | 🌐 Python | 📅 2025-11-18
4. metahuman-stream: Real time interactive streaming digital human <https://github.com/lipku/metahuman-stream> ⭐ 9,271 | 🐛 235 | 🌐 Python | 📅 2026-08-29
...
1. SenseVoice (multilingual) <https://github.com/FunAudioLLM/SenseVoice> ⭐ 9,173 | 🐛 4 | 🌐 C | 📅 2026-08-27 👍👍
2. BELLE-2/Belle-whisper-large-v3-zh <https://huggingface.co/BELLE-2/Belle-whisper-large-v3-zh>

### Text to Speech (TTS)

1. GPT-SoVITS <https://github.com/RVC-Boss/GPT-SoVITS?tab=readme-ov-file> ⭐ 61,338 | 🐛 888 | 🌐 Python | 📅 2026-08-18
2. CosyVoice, Alibaba Tongyi SpeechTeam <https://github.com/FunAudioLLM/CosyVoice> ⭐ 23,067 | 🐛 708 | 🌐 Python | 📅 2026-05-25 👍👍
3. FireRedTTS, FireReadTeam <https://github.com/FireRedTeam/FireRedTTS> ⭐ 919 | 🐛 37 | 🌐 Python | 📅 2025-09-28

### Speech to Speech (GPT4-o)

1. Speech To Speech, HuggingFace <https://github.com/huggingface/speech-to-speech> ⭐ 12,933 | 🐛 99 | 🌐 Python | 📅 2026-08-28
