...
|          3DGS          |             [3D Gaussian Splatting for Real-Time Radiance Field Rendering](https://arxiv.org/abs/2308.04079), Inria, SIGGRAPH 2023            | [A Comprehensive Overview of Gaussian Splatting](https://towardsdatascience.com/a-comprehensive-overview-of-gaussian-splatting-e7d570081362) | [Code](https://github.com/graphdeco-inria/gaussian-splatting) ⭐ 22,963 \| 🐛 713 \| 🌐 Python \| 📅 2025-10-17 |       real-time 3d rendering      |
...
4. metahuman-stream: Real time interactive streaming digital human <https://github.com/lipku/metahuman-stream> ⭐ 8,804 | 🐛 402 | 🌐 Python | 📅 2026-08-07
...
2. SenseVoice (multilingual) <https://github.com/FunAudioLLM/SenseVoice> ⭐ 9,084 | 🐛 0 | 🌐 C | 📅 2026-08-12 👍👍

### Text to Speech (TTS)

1. GPT-SoVITS <https://github.com/RVC-Boss/GPT-SoVITS?tab=readme-ov-file> ⭐ 60,947 | 🐛 888 | 🌐 Python | 📅 2026-07-22
2. CosyVoice, Alibaba Tongyi SpeechTeam <https://github.com/FunAudioLLM/CosyVoice> ⭐ 22,781 | 🐛 729 | 🌐 Python | 📅 2026-05-25 👍👍
3. FireRedTTS, FireReadTeam <https://github.com/FireRedTeam/FireRedTTS> ⭐ 913 | 🐛 37 | 🌐 Python | 📅 2025-09-28

### Speech to Speech (GPT4-o)

1. Speech To Speech, HuggingFace <https://github.com/huggingface/speech-to-speech> ⭐ 12,557 | 🐛 118 | 🌐 Python | 📅 2026-08-14
